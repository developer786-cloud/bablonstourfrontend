...
const BlogDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    const setMeta = (selector, attrs) => {
      if (selector === 'meta[property="article:tag"]') {
    ...
    setMeta('meta[name="author"]', { name: 'author', content: post.author || SITE_NAME })
    ...
    setMeta('meta[property="article:published_time"]', { property: 'article:published_time', content: post.publishedAt || post.createdAt })
    setMeta('meta[property="article:modified_time"]', { property: 'article:modified_time', content: post.updatedAt || post.publishedAt || post.createdAt })
    if (post.category) setMeta('meta[property="article:section"]', { property: 'article:section', content: post.category })
    if (post.tags?.length) {
      post.tags.forEach((tag) => {
        setMeta('meta[property="article:tag"]', { property: 'article:tag', content: tag })
      })
    }
